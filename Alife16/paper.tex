...
threshold to join them is much lower. %Pablo: this is useful for us because...
...
enhance performance. %Pablo: On the contrary, in this paper, we...
...
%Pablo: I miss some definition for the concept "sociotechnical metacomputer" in the introduction
metacomputer. Apol{\'o}nia et al. \citep{apolonia2012enhancing} used the
...
users' social networks. %Pablo: Add a phrase here to better link with the previous description of the work of Apolonia (it is a sudden huge jump from one topic to another)
...
IPs, and of the same order, between 10 and 100 seconds. 
...
\end{figure}
%
 This exponential distribution also appears in the
