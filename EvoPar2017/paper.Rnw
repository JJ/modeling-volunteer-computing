...
Using a peer to peer approach, the SPACE framework \cite{Leclerc2016} distributes fitness 
...
Anetsberger & Bongard in which they propose training simulated robots 
the grounding of language symbols. They do this by using human 
