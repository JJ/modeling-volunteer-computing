...
\begin{figure}[htbp]
\centering
<<zipf, cache=FALSE,echo=FALSE, fig.width   = 9, fig.height  = 6>>=
...
\begin{figure}[ht!b]
\centering
<<minutedata, cache=FALSE,echo=FALSE, fig.width   = 9, fig.height  = 6, fig.dpi     = 100>>=
...
\begin{figure}[ht!b]
\centering
<<entropy,cache=FALSE,echo=FALSE,fig.width=9,fig.height=6,dpi=200,dev='png'>>=
