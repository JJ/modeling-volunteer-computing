...
\title{NodIO: a framework and architecture for pool-based evolutionary
  computation} 
%
...
many other outside. Tesearchers can, in fact, write their fitness
...
requests sent to the server so that that particular worker can be
...
whatever resources, desktop computers, laptop or cloud, are availab.e 
