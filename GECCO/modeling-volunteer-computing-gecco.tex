...
%
\begin{figure*}[h!tb]
  \includegraphics[width=0.90\linewidth]{img/openshift-intervals.png}
...
difficult optimization problem. Eventually. 
...
audience using lapto computers, most of the participants in the experiment were in the same
...
of a single several-core desktop computer. This will be explored in
future work.
