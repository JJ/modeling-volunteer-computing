...
\multicolumn{2}{|c|}{Median PUTs} & \#Runs & Different IPs\\
           &   (ms)        & Total & Used & Total & Used &
           &\\
\hline
base & 120056.0 & 10 & 4 & 256.0 & 21.0 & 81 & 262\\
\hline
graph1 & 152619.5 & 9 & 4 & 212.5 & 26.5 & 36 & 96\\
graph2 & 1173561.5 & 6 & 4 & 761.5 & 22.0 & 36 & 73\\
\hline
reboot & 796214.0 & 9 & 6 & 646.0 & 67.0 & 45 & 168\\
\hline
cachereboot & 392917.0 & 12 & 12 & 576.0 & 79.0 & 55 & 225\\
\hline
\end{tabular}
...
ggplot(ips.data,aes(x=idx,y=PUTs,group=Experiment,color=Experiment))+geom_point()+scale_y_log10()+ scale_colour_discrete(labels=c('base','graph1','graph2','reboot','cachereboot'))
...
been voided and was filling again. 
