...
ggsave('gev-fit-ww.rastrigin.png',width=5,height=5)
...
ggsave('weibull-fit-ww.rastrigin.png',width=5,height=5)
...
ggsave('gev-fit-ww.rastrigin.workers.png',width=5,height=5)
