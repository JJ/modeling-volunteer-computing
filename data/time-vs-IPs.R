...
ggplot(data=ips.time, aes(x=IPs,y=milliseconds,color=howmany))+geom_point()+scale_y_log10()+ scale_colour_gradient(name  ="Count", low="#11AA99",high='#EE3333')+ stat_summary(fun.data = "mean_cl_boot", colour = "black")
ggsave("../img/ips-time-ww.png", width=5,height=5)
