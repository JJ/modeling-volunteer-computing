...
ggplot(data=ips.time, aes(x=IPs,y=milliseconds,color=howmany))+geom_point()+scale_y_log10()+ scale_colour_gradient(name  ="Count", low="white",high='gray70')+ stat_summary(fun.data = "mean_cl_boot", colour = "black")
