...
\author{ J. J. Merelo Guerv�s and Pablo Garc�a-S�nchez\\
  Dept. of Computer Architecture and Technology and CITIC\\
  University of Granada\\
  \texttt{(jmerelo,pablogarcia)@ugr.es}
}
...
\begin{abstract}
Browsers have scaled from simple page-rendering engines to operating
...
conferences\footnote{Names withheld for the double blind review}. During the
...
repository \url{https://github.com/JJ/idc-keynote}. These results
