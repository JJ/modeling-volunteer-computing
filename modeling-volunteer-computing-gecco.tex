...
\section{Materials: running an island model in the browser}
\label{sec:exp}
...
module and has three REST \cite{Castillo12REST} %FERGU: cito a este
                                %paper que es un capítulo de libro en
                                %vez de Arxiv
% OK - JJ
