...
easier. I has been written using node.js and the {\tt express.js}
module and includes the following REST \cite{Castillo12REST} 
routes:
\begin{itemize}
...
The server program includes more logic to serve the static pages
