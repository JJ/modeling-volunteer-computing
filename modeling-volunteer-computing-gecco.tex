...
previous version. %FERGU: es esta la única innovación al paper de
                  %Arxiv? A lo mejor no deberíamos mencionarlo ni
                  %usarlo como base
% La principal innovación es que es más fácil recoger datos del
% servidor y que el despliegue es automático - JJ
...
this case the design, which used the Kube CSS framework, was fully
