...
%FERGU: Creo que te falta terminar las conclusiones, pero por si acaso habría que decir: Este tipo de computación se basa en tal y tal y tiene tales problemas. Nuestra metodología ha propuesto usar tal tecnología por tal y tal. Los resultados demuestran que los usuarios hacen tal y tal y que por lo tanto hay que tener en cuenta el tal. Bueno, qué te voy a contar...
