...
\begin{quote}\textbf{
1) Be careful with the use of acronyms. They must be defined the first time appearing in the text. Moreover, the use of too many acronyms jeopardizes readability of the manuscript. Please, keep only those acronyms which are really needed.
