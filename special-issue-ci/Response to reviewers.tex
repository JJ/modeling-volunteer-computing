...
have published these tests as an open access technical report. This
fact, along these explanations, have now been added to the first
paragraph of the {\em Description of the system} section. 
...
\begin{quote}
- According the last paragraph of the introduction, ÒThen, a detailed description of the proposed system is
