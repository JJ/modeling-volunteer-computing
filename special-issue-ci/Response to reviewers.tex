...
not an exclusively browser-based one. Its a pool-based architeture that allows
...
they use different shades, so it should mostly work in grayscale. For the time being and
