...
This has been included as the last subsection of the paper.
...
a way (and failed) to make it more readable for reviewers. For the time being and
during the revision phase, we prefer to keep it that way, but we will
change it to grayscale if it is needed for the final version. 
