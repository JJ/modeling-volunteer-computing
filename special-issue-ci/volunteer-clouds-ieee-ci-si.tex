...
991ms, JavaScript took 32\% more time than Java with 1240ms in Chrome using a 
single Web Worker and 1,270ms using Node.js. % Are these results correct? JS=>1240ms and Node.js=>1,270ms ???
...
and \tt{ classic-ea-float} modules where used. The parameters for the ea algorithm 
...
As before, a few participation calls were published in throu posts in social networks.
