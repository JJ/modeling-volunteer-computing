...
single Web Worker and 1,270ms using Node.js. 
...
of a chromosme was 1000 double precision numbers, considereing this size
of the pool was limited to 10,000 chromosomes.  In order to keep this size
constant a random chromosme was pulled out of the pool before inserting a
new one, when the pool was full.
