...
still has a long way to go if it is going to become a mainstream
technology in the same way the cloud technologies in general have. The
lack of general purpose and open source tools with analytics built in
...
that include volunteers and that user behaviour follows some patterns,
