...
to measure execution time, but the maximum resolution is given in miliseconds.
In order to measure the runtime intervals with higher precission two functions
...
browsers and desktop. These tools included package managers, debbugers, logs, 
...
limited precision of 64 bits that partialy implements the functionality of
the {\tt StrictMath} library used by the Java implemantation. If more precision
is needed developers could use {\tt math.js}, an extensive math library with support for matrices, big and complex numbers.
...
algorithms. To test the performance of JavaScript against Java and Matlab 
