...
the evolutionary algorithm start again. % (Paloma) Feature or disadvantage?
...
of computers happened less frequently, while darker shadow means more frequence. From left to right, experiments 4/4, 4/24 and 7/31.}
\label{fig:duration}
\end{figure}
%
\begin{figure}[!htb]
