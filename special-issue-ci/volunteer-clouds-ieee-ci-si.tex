...
\cite{baratloo1999charlotte}, but it is interesting to note that, even
in the early stages of the web, the possibility of 
...
This is part due to the fact that the presence of nodes is not
constant, as shown in Figure \cite{fig:ips:rastrigin}, which plots the
...
indicates a decreasing distribution of the same kind. 

In general, this experiment confirms what was found in the others in
several aspects: first, there is a regularity in the distribution of
