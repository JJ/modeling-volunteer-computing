...
991ms, JavaScipt took 32\% more time than Java with 1240ms in Chrome using a Web Worker and 1,270ms using Node.js. 
The results also show that there is not much difference between the Node.Js implemenation an that of a
...
kind of processing is not intended for the main thread. Also there is not much diference when running two
