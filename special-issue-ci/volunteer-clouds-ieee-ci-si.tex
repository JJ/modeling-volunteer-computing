...
That is why we have enhenced {\sf NodIO}, a framework used to create client-server architectures 
for distributed evolutionary algorithms, resulting in {\sf NodIO-W$^2$}, which we present in this paper.
...
experiments that include volunteers, and then that user behavior follows some patterns, and, thus, are amenable to a model.
