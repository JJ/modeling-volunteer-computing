...
Figure \ref{fig:system} describes the system.

\begin{figure}[!t]
\centering
\includegraphics[width=4in]{img/system.pdf}
\caption{Description of the used system. Clients execute a JS EA in the browser. Every 100 generations it sends the best individual and receives a random one from the server.}
\label{fig:system}
\end{figure}
