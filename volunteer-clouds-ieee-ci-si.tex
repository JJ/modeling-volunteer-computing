...
in Figure \ref{fig:put:os}. The results related to user contributions
are shown in Table \ref{tab:put:os}.
%
\begin{table*}
...
\item Several instances of the NodEO script can be executed in parallel in a single web page. 
