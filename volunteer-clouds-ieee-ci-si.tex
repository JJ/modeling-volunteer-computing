...
%was introduced in 1997 as a 
%browser-embedded language and has, since then,
%Ya se había dicho  
...
XMLHttpRequest (XHR) object. %FERGU: Qué es el objeto XHR? Alguna
                             %referencia/justificación de por qué se
                             %usa? 
\end{itemize}
%
\begin{figure}[!htb]
...
running for as long as they want and they will be contributing %borrado un to
