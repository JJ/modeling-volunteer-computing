...
\author{Juan-J.~Merelo*$^1$, Mario Garcia-Valdez$^2$, Pedro A. Castillo$^1$
...
\thanks{E-mail addresses: jmerelo@ugr.es , mario@tectijuana.edu.mx , pacv@ugr.es}%
...
used. JavaScript is a functional language and 
